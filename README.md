...
| `apps/demo-web/.env.local.example` | `pnpm --filter demo-web dev` | `NEXT_PUBLIC_WALLETCONNECT_PROJECT_ID`, `NEXT_PUBLIC_BUNDLER_RPC_URL`, `NEXT_PUBLIC_PAYMASTER_API_URL`, `NEXT_PUBLIC_ENTRYPOINT_ADDRESS`, `NEXT_PUBLIC_PERMIT2_ADDRESS`, `NEXT_PUBLIC_FACTORY_ADDRESS`, optional `NEXT_PUBLIC_ACCOUNT_INIT_CODE`, `NEXT_PUBLIC_TOKEN_ADDRESS`, optional `NEXT_PUBLIC_TOKEN_SYMBOL`, optional `NEXT_PUBLIC_TOKEN_DECIMALS`, `NEXT_PUBLIC_DEMO_DAPP_ADDRESS`, `NEXT_PUBLIC_CAMPAIGN_ID` |
